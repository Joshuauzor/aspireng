...
<div class="navigation">
	...
	<header class="navigation-header">
		...
		<div>
			...
			<ul class="nav">
				<li class="nav-item">
					<a href="<?= base_url('admin/home/profile') ?>" class="btn nav-link bg-info-bright" title="Profile"
					   data-toggle="tooltip">
	...
	<div class="navigation-menu-body">
		<ul>
			...
			<li>
				...
				<ul>
					<li><a href="<?=base_url('admin/admin_request/newrequest')?>">New request</a></li>
					<li><a href="<?=base_url('admin/admin_request/approvedrequest')?>">Approved request</a></li>
					<li><a href="<?=base_url('admin/admin_request/declinedrequest')?>">Declined request</a></li>
				</ul>
			</li>
			<li>
                <a href="<?= base_url('admin/home/userdetails') ?>">
			...
			<li>
				...
				<ul>
					<li><a href="<?=base_url('admin/admin_request/addservices')?>">Add services</a></li>
					<li><a href="<?=base_url('admin/admin_request/removeservices')?>">Remove services</a></li>
					<li><a href="<?=base_url("#")?>">Edit services</a></li>
				</ul>
			</li>
			<!-- <li>
				<a href="#">
				...
				<ul>
					<li><a href="#">Register technician</a></li>
					<li><a href="#">Remove technician</a></li>
					<li><a href="#">Active technician</a></li>
				</ul>
			</li> -->
		</ul>
	</div>
