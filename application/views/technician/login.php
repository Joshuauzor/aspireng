...
<div class="container">
    ...
    <?php if($this->session->flashdata('stop')): ?>
                <div class="alert alert-danger"><?=$this->session->flashdata('stop')?></div>
    <?php endif; ?>
    ...
    <form action = "<?=base_url('technician/login')?>" method = "post">
        ...
        <a href="<?=base_url("technician/register")?>" class="btn btn-outline-light btn-sm">Register now!</a>
    </form> -->
    <!-- ./ form -->
