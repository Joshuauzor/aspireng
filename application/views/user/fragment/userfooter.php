 ...
 <footer>
     <div class="container">
         <!-- <div>©  Made by <a href="http://facebook.com/joshuauzor">Zeal technologies</a></div> -->
         <div>Copyright &copy;<script>document.write(new Date().getFullYear());</script> Aspire Solutions. All Rights Reserved | Powered by <a href="https://zealtech.com.ng">Zeal Technologies</a></div>
        </div>
 </footer>
 <!-- end::footer -->
